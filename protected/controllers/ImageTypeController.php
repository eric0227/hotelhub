...
class ImageTypeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['ImageType'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_image_type));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('ImageType');
	...
	{
		$model=new ImageType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ImageType']))
			$model->attributes=$_GET['ImageType'];
	...
	{
		$model=ImageType::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='image-type-form')
		{
