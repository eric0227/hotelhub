...
class SearchCar {
	...
	static public function findAllSupplier($search) {
		...
		$cmd = Yii::app()->db->createCommand()
				->select('pro_date.*, pro_lang.*, car.*, sup_lang.*')
				...
				->join('gc_car as car', 'car.id_product = pro_date.id_product')
	...
	static public function findAllCar($search /*$id_supplier, $country, $destination, $start_date = null, $last_date = null, $id_product = null */) {
	...
	static public function findInfoCar($id_product) {
