...
<?php $this->widget('bootstrap.widgets.TbDetailView',array(
	...
	'attributes'=>array(
		'id_product',
		'id_supplier',
		array('name'=>'room_code', 'value'=>$model->roomCode->name),
		'room_type_code',
		'lead_in_room_type',
		'full_rate',
		'min_night_stay',
		'max_night_stay',
		array('name'=>'room_name', 'value'=>$model->product->name),
		//array('name'=>'room_description', 'value'=>$model->product->description_short),
		'guests_tot_room_cap',
