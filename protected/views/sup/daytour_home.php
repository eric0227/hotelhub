...
<form>
<div>
	<a href="<?php echo CController::createUrl('daytour/create'); ?>"><div class="button">NEW Product</div></a>
...
<div class="supplier_details">
	...
	<?php
		$models = Product::model()->findAllByAttributes(array('id_supplier'=>Yii::app()->user->id_user));
	...
	<script>
		...
		<?php //echo CHtml::button('Car Image', array('submit' =>array(Yii::app()->request->baseUrl . '/imageProduct/index', array('id_product'=>$model->id_product)))); ?>
		<?php echo CHtml::button('Product Image', array('onclick' => 'goPage("'.Yii::app()->request->baseUrl . '/imageProduct/index?id_product='.$model->id_product.'")')); ?>
