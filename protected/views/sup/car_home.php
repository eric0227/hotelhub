...
<form>
<div>
	<a href="<?php echo CController::createUrl('car/create'); ?>"><div class="button">NEW CAR</div></a>
...
<div class="supplier_details">
	...
	<?php
		$models = Car::model()->findAllByAttributes(array('id_supplier'=>Yii::app()->user->id_user));
	...
	<script>
		...
		<?php echo CHtml::button('Car Image', array('onclick' => 'goPage("'.Yii::app()->request->baseUrl . '/imageProduct/index?id_product='.$model->id_product.'")')); ?>
