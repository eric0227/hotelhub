...
<div id="left_columns">
	...
	<div id="find_accommodation_index">
		<form action="<?php echo Yii::app()->request->baseUrl; ?>/frontCarRental/suppliers" method="get" name="find_accommodation_form" id="find_accommodation_form" class="form">
			...
			<div class="row center">
				<input type="submit" value="Search CarRental Service" onclick="return hotel.submit();" />
			</div>
		</form>
	</div>
</div>
...
?>		
		<div class="item" onClick="location='<?php echo Yii::app()->request->baseUrl.'/frontCarRental/products?id_supplier='. $model->supplier->id_supplier ?>'">
