...
$this->menu=array(
	...
	array('label'=>'Update Product','url'=>array('update','id'=>$id)),
	array('label'=>'Delete Product','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$id),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Images', 'url'=>array('/imageProduct/index','id_product'=>$id)),
