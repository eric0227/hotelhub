...
$this->menu=array(
	...
	array('label'=>'Product Images', 'url'=>array('/imageProduct/index','id_product'=>$model->id_product)),
	array('label'=>'Product Date', 'url'=>array('/productDate/index', 'id_product'=>$model->id_product))
);
?>
