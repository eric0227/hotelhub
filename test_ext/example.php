...
<BODY>
	<a
		href="<?php echo $_SERVER['PHP_SELF'] . SID ?>?endpoint=Accounts&start=1">Accounts</a>
	<br />
	<a
		href="<?php echo $_SERVER['PHP_SELF'] . SID ?>?endpoint=Organisation&start=1">Organisation</a>
	<br />
	<a
		href="<?php echo $_SERVER['PHP_SELF'] . SID ?>?endpoint=Invoices&start=1">Invoices</a>
	<br />
	<a
		href="<?php echo $_SERVER['PHP_SELF'] . SID ?>?endpoint=Contacts&start=1">Contacts</a>
	<br />
	<a
		href="<?php echo $_SERVER['PHP_SELF'] . SID ?>?endpoint=Currencies&start=1">Currencies</a>
	<br />
	<a
		href="<?php echo $_SERVER['PHP_SELF'] . SID ?>?endpoint=TrackingCategories&start=1">TrackingCategories</a>
	<br />
	<a
		href="<?php echo $_SERVER['PHP_SELF'] . SID ?>?endpoint=Journals&start=1&order=JournalDate">Journals</a>
	<br />
	<a
		href="<?php echo $_SERVER['PHP_SELF'] . SID ?>?action=ChangeToken&start=1">Token
		Refresh</a>
	<br />
	<a href="<?php echo $_SERVER['PHP_SELF'] . SID ?>?put=put&start=1">PUT
		Invoice</a>
	<br />
	<a href="<?php echo $_SERVER['PHP_SELF'] . SID ?>?post=post&start=1">POST
		Invoice update</a>
	<br />
</BODY>
</HTML>
