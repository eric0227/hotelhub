...
--
-- Host: localhost
-- Generation Time: Nov 19, 2012 at 11:18 PM
...
INSERT INTO `gc_address` (`id_address`, `id_destination`, `id_country`, `id_state`, `id_user`, `address_code`, `alias`, `company`, `lastname`, `firstname`, `address1`, `address2`, `postcode`, `city`, `other`, `phone`, `phone_mobile`, `vat_number`, `dni`, `date_add`, `date_upd`, `active`, `deleted`) VALUES
(1, NULL, 24, 316, 1, '001001', '001001', 'gna', 'Lee', 'Eric', '432 fdfsd', 'fdsfdsa', '2072', 'sydney', '', '6123212321', '6123212321', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 0),
(2, NULL, 24, 316, 4, '001002', '001002', '', 'Lee', 'Eric', '432 fdfsd', 'delivery', '2072', 'sydney', '', '6123212321', '6123212321', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 0),
(4, NULL, 24, 316, 4, '001003', '001003', 'gna', 'eric', 'lee', 'fdsaf', '32', '2072', 'sydney', '', '', '', '', '', '2012-11-16 22:17:07', '2012-11-16 22:17:07', 1, 0);
...
(32, 'Sunset.jpg', '/images/supplier/2', 'sunset', 0, 0);
...
(1, 1, 2, 1, 0, 10, 0.000000, 0.000000, 0.000000, 0, 0, 0, 0, 2, 0, 'new', 1, 0, '0000-00-00 00:00:00', '2012-11-16 09:34:14');
...
INSERT INTO `gc_product_date` (`id_product_date`, `id_product`, `on_date`, `price`, `agent_price`, `quantity`) VALUES
(1, 1, '2012-11-16 00:00:00', 100.000000, 80.000000, 100);
...
INSERT INTO `gc_room` (`id_product`, `id_supplier`, `room_code`, `room_type_code`, `lead_in_room_type`, `full_rate`, `min_night_stay`, `max_night_stay`, `room_name`, `root_description`, `guests_tot_room_cap`, `guests_included_price`, `children_maxnum`, `children_years`, `children_extra`, `adults_maxnum`, `adults_extra`) VALUES
(1, 2, '002001', '123', 0, 0, 0, 0, '', '', 0, 0, 0, 0, 0.000000, 0, 0.000000);
...
(3, 3, 2, '규형', '이', 'agent@holidoy.com.au', 'f09e619e3aa89309400e670d4cab9ffb', 0, '', '0000-00-00', 1, 0),
...
ALTER TABLE `gc_address`
  ...
  ADD CONSTRAINT `gc_address_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `gc_user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
